...
4. The Photos page SHALL use the shared cyberpunk palette (`#00f3ff` cyan, `#005f8c` deep blue, `#ff00ea` magenta) for panel borders, tab gradients and corner accents. (PXCP-04)
